...
export default function TablesPage() {
  ...
  function selectTable(table: any) {
    if (table.status === "REQUESTING_BILL") {
      const order = orders.find((item) => item.tableId === table.id && item.table?.status === "REQUESTING_BILL")
